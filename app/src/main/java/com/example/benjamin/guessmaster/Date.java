...
public class Date {
	...
	public Date(String strDate) {
		...
		setDate(Integer.parseInt(str[0]), Integer.parseInt(str[1]), Integer.parseInt(str[2]));
	}
	...
	// parseInput is a static function that checks whether or not a string input
	// follows
	// the mm/dd/yyyy format. this is used in the GuessMaster class to do validation
	// before
